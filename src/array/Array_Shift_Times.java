...
public class Array_Shift_Times {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(shiftArray2(arr, 3)) );
        System.out.println(Arrays.toString(shiftArray3(arr, 3)) );
    ...
    static int[] shiftArray3(int[] arr, int times){
        ...
        for (int i = 0; i < result.length; i++, shift++) {
            if(shift<len)result[shift] = arr[i];
            else result[shift-len]=arr[i];
        }
