...
public class Number_ConsecutiveNumbers {
    ...
    /*
    Simple we just check remainders and if they zero replace with text needed
     */
    public static void consecutive(int num){
        for (int i = 1; i <=num ; i++) {
            String replaceText="";
            if (i%2==0 || i%3==0 || i%5==0){
                if (i%2==0) replaceText+="Codility";
                if (i%3==0) replaceText+="Test";
                if (i%5==0) replaceText+="Coders";
